#!/bin/bash
# Agentic On-Policy Distillation with Hard Difficulty Problems (Qwen Version)

set -e

echo "====================================================================="
echo "RTL Agent - Agentic On-Policy Distillation (Hard Problems - Qwen)"
...
DATASET_PATH="cvdp_hard_problems.jsonl"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
LOG_DIR="./logs/qwen_agentic_distill_hard_${TIMESTAMP}"
WORKSPACE_DIR="./workspaces/qwen_agentic_workspace_hard_${TIMESTAMP}"

echo ""
echo "Configuration:"
echo "  Student: Qwen/Qwen3-8B"
echo "  Teacher: Qwen/Qwen3-32B"
echo "  Dataset: $DATASET_PATH (20 hard problems)"
